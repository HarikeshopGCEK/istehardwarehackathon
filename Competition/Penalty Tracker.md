...
- **Sensor Penalty**: 10 points deducted per sensor over 5-sensor limit
- **BOM Status**: ✅ Approved | ⏳ Pending | ❌ Rejected

*Note: Final scores will be updated after judge evaluation and penalty application*